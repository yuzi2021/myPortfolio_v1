...
window.projectsData = [
    {
        ...
        description: {
            en: "A privacy and security by design study project — documenting what responsible development looks like before a line of application code is written. FridgeReady processes Article 9 special category data (dietary restrictions, health goals, religious preferences) and children's data, making genuine privacy engineering non-negotiable. The repository covers the full security design lifecycle: STRIDE threat modelling, DPIA and RoPA, ISO 27001 Annex A control mapping across 23 controls, vendor risk assessments for four processors, and NIST SP 800-61r2 incident response playbooks and runbooks for three threat scenarios — including a playbook for Article 9 data leakage to third-party error monitoring.",
            fi: "Tietosuoja- ja tietoturvalähtöinen opiskeluprojekti — dokumentoi vastuullisen kehittämisen ennen kuin yhtäkään koodiriviä on kirjoitettu. FridgeReady käsittelee GDPR:n artikla 9:n mukaisia erityiskategorioiden henkilötietoja (ruokarajoitukset, terveystavoitteet, uskonnolliset mieltymykset) sekä lasten tietoja. Repositorio kattaa koko tietoturvasuunnittelun elinkaaren: STRIDE-uhkamallinnus, DPIA ja RoPA, ISO 27001 liitteen A kontrollikartoitus 23 kontrollin osalta, toimittajariskiarvioinnit neljälle prosessoijalle sekä NIST SP 800-61r2 -häiriöidenhallintasoitteet ja -runbookit kolmelle uhkaskenaariolle."
        },
        featured: true,
